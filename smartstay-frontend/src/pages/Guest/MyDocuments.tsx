      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <div className="text-xl text-gray-600">Loading your documents...</div>
          </div>
        ) : documents.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <div className="text-6xl mb-4">📄</div>
            <p className="text-xl text-gray-600 mb-4">No documents uploaded yet</p>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="space-y-1 text-sm text-gray-600">
                        ...
                        <p>
                          <span className="font-medium">Document ID:</span> #{document.documentID}
                        </p>
                      </div>
                      ...
                      {document.status === 'Rejected' && (
                        <div className="mt-3 bg-red-50 border-l-4 border-red-500 p-3 rounded">
                          <p className="text-sm text-red-700">
                            <strong>Rejected:</strong> Please upload a valid document or contact support for assistance.
                          </p>
                        </div>
                      )}
                      ...
                      {document.status === 'Verified' && (
                        <div className="mt-3 bg-green-50 border-l-4 border-green-500 p-3 rounded">
                          <p className="text-sm text-green-700">
                            <strong>Verified:</strong> Your document has been approved.
                          </p>
                        </div>
                      )}
                    </div>

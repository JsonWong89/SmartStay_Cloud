...
export const roomsAPI = {
  ...
  getAvailableRooms: async (checkIn: string, checkOut: string, hotelId?: number) => {
    ...
    return apiCall<{ success: boolean; data: AvailableRoom[] }>(
      `/api/rooms/staff/available?${params}`
    );
  },
